      ...
      <MidBox>
        <div className="w-full h-full bg-gradient-to-r from-gfirst to-glast flex items-stretch">
          <Link className="w-full h-full p-7" to="/studtask/">
            <div className="text-2xl mb-0 flex">
              <img
            ...
            <p className="font-mono font-bold text-gray-500 text-lg">
              Online event planning system for students
            </p>
            <img
      ...
      <MidBox>
        <div className="w-full h-full bg-white dark:bg-primary dark:text-white flex items-stretch">
          <Link className="w-full h-full p-7" to="/about/">
            <div className="text-2xl mb-0 flex">
              <img
                className="w-10 h-10 ml-1 hidden dark:block"
                alt="ProfileW"
                src={ProfileW}
              />
              <img
                className="w-10 h-10 ml-1 dark:hidden"
                alt="ProfileB"
                src={ProfileB}
              />
      ...
      <div className="flex flex-col justify-between">
        <SmallBox>
          <div className="w-full h-full bg-white dark:bg-primary dark:text-white flex items-stretch">
            ...
            >
              <img
                className="mt-5 ml-1 w-36 hidden dark:block"
                alt="GHlogoW"
                src={GitHubLogoW}
              ></img>
              <img
                className="mt-5 ml-1 w-36 dark:hidden"
                alt="GHlogoB"
                src={GitHubLogoB}
              ></img>
            </a>
