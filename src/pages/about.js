...
const About = () => (
  <Layout>
    ...
    <div className="animate-slideInFromBottom lg:px-24 lg:pt-16 lg:pb-24 lg:bg-white lg:dark:bg-primary">
      <p className="text-2xl text-justify text-greySecondary">
        Graduate of computer science with no work experience yet. I’ve built a
        few projects by myself and I’m looking for a role where I can grow and
        learn from other experienced team members.
      </p>
      <div className="lg:border-2 rounded-2xl flex lg:flex-row flex-col">
        ...
        <div className="lg:w-1/2 w-full my-auto lg:px-10">
          ...
          <br />
          <p className="m-0 dark:text-white text-xl">
            LinkedIn:{" "}
            <a
              className="text-blue-700"
              href="https://linkedin.com/in/viktor-pikulyk"
            >
              /in/viktor-pikulyk
            </a>
          </p>
          <p className="m-0 dark:text-white text-xl">
            ...
            <a
              className="text-blue-700"
              href="https://github.com/ViktorPikulyk"
            >
              github.com/ViktorPikulyk
            </a>
          </p>
        </div>
      </div>
      <div className="lg:border-2 rounded-2xl flex lg:flex-row flex-col mt-6">
        ...
        <div className="lg:w-1/2 w-full lg:mt-10 lg:px-10">
          ...
          <ul className="list-disc dark:text-white">
            <li>
              Designed and implemented an online event planning system for
              students.
            </li>
            <li>
              Built fast and responsive web app using latest MERN Stack
              techniques.
            </li>
            <li>Used: Node.js, React, MongoDB, GraphQL.</li>
          </ul>
        </div>
      </div>
      <div className="lg:border-2 rounded-2xl flex lg:flex-row flex-col mt-6">
      ...
      <div className="lg:border-2 rounded-2xl flex lg:flex-row flex-col mt-6">
        ...
        <div className="lg:w-1/2 w-full lg:my-10 lg:px-10">
          ...
          <p className="m-0 dark:text-white text-2xl font-bold">
            B.S. in Computer Science
          </p>
          <p className="m-0 dark:text-white text-md">
            (September 2017 - June 2021)
          </p>
          <br />
          <p className="m-0 dark:text-white text-xl text-justify">
            Relevant courses: Algorithmic and OOP Programming, Data Science,
